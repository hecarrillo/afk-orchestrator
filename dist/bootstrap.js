...
export function bootstrap() {
    ...
    try {
        ...
        process.stderr.write(`error: could not determine bootstrap base.\n` +
            `${msg}\n` +
 ...
 */
export function autoDetectBase(workDir) {
    let out;
    try {
        ...
        throw new Error(`not a git repo (or git not on PATH): ${stderr.trim() || err.message}`);
    }
