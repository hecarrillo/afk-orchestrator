...
export interface ClaudeRunOptions {
  ...
  prompt: string;
  timeoutMs: number;
  // Stream stdout/stderr to the orchestrator's stdout with a prefix? Useful
  // when watching multiple agents fan out. Default: yes.
  stream?: boolean;
  // Label printed before each streamed line (e.g. "impl-12" / "review-12").
  label?: string;
}
